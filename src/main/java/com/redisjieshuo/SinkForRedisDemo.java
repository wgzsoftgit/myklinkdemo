...
public class SinkForRedisDemo {
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> text = env.socketTextStream("xxx", 9090, "\n");
        //lpush l_words word
        ...
        //创建redis的配置
        FlinkJedisPoolConfig conf = new FlinkJedisPoolConfig.Builder().setHost("127.0.0.1").setPort(9096).build();
